...
ggsave("plots/EDA/distribution_titles_per_titleType.pdf",
  width = 10,
  height = 4
)
...
ggsave("plots/EDA/distribution_titles_per_language.pdf",
  width = 14,
  height = 4
)
...
ggsave("plots/EDA/popularity_of_movies_and_shorts_per_titleType.pdf",
  width = 10,
  height = 4
)