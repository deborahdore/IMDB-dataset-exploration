...
all_genres = c("Action", "Adventure", "Animation" ,"Comedy", 
               ...
               "Sci-Fi", "Thriller")
all_genres = c("Action", "Crime", "Mystery", "Drama", "Comedy")
...
ggsave("plots/analysis/analysis_genres_violin.pdf", height = 5, width = 7)
...
ggplot(tb[(success)], aes(x = genres, y = total_success, fill = genres,
  ...
  theme(axis.text.x=element_text(angle=40,hjust=1),
        legend.position = "none")
, ncol = 1)
ggsave("plots/analysis/analysis_genres_distribution.pdf", height = 7, width = 5)
