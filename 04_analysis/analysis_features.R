...
pdf(file="./plots/analysis/corr_series.pdf", width = 4, height =4)
...
pdf(file="./plots/analysis/corr_series_crime.pdf", width = 4, height =4)
...
pdf(file="./plots/analysis/corr_series_drama.pdf", width = 4, height =4)
...
pdf(file="./plots/analysis/corr_series_action.pdf", width = 4, height =4)
...
pdf(file="./plots/analysis/corr_series_mistery.pdf", width = 4, height =4)
...
pdf(file="./plots/analysis/corr_series_comedy.pdf", width = 4, height =4)
...
pdf(file="./plots/analysis/corr_series_scify.pdf", width = 4, height =4)
