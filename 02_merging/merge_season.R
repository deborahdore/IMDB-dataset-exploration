...
te = fread(paste0(path, "/title.episode.clean.csv"))
tb = fread(paste0(path, "/title.basics.clean.csv"))
...
tc = fread(paste0(path, "/title.crew.clean.csv"))
...
tr = fread(paste0(path, "/title.ratings.clean.csv"))
...
tp = fread(paste0(path, "/title.principals.clean.csv"))
tp[, playsSelf := NULL]
